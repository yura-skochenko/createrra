...
/* Zoom */
var f = void 0, h = !0, j = null, k = !1, q, r = jQuery, s = ["DOMMouseScroll", "mousewheel"];
function t(a) {
    var c = a || window.event, b = [].slice.call(arguments, 1), d = 0, e = 0, g = 0;
    a = r.event.fix(c);
    a.type = "mousewheel";
...
r.event.special.mousewheel = {
    setup: function () {
        if (this.addEventListener) for (var a = s.length; a;) this.addEventListener(s[--a], t, k); else this.onmousewheel = t
    }, teardown: function () {
        if (this.removeEventListener) for (var a = s.length; a;) this.removeEventListener(s[--a], t, k); else this.onmousewheel = j
    }
};
r.fn.extend({
...
var B = window, C = B["Function"], D = h, E = k, F = "NOTAPP", G = "TRIAL".length, H = k, I = k;
5 == G ? I = h : 4 == G && (H = h);
function J(a, c) {
    function b() {
        g.update();
...
J.prototype.ra = function (a) {
    ...
    if (0 == this.m.length) return {href: this.options.zoomImage, title: this.a.attr("title")};
...
J.prototype.I = function (a, c) {
    ...
    this.a.bind("mouseover.prehov mousemove.prehov mouseout.prehov", function (a) {
        b.C = "mouseout" == a.type ? j : {pageX: a.pageX, pageY: a.pageY}
    });
    this.K();
    ...
    this.N = "" != c && c != f ? c : a;
    this.U = this.$ = k;
    b.T && !("inside" == b.options.zoomPosition && b.h != j) && (b.j = r(new Image).css({position: "absolute"}), b.j.attr("src", b.a.attr("src")), b.j.width(b.a.width()), b.j.height(b.a.height()), b.j.offset(b.a.offset()), r("body").append(b.j));
    this.va();
    this.u = new K(b.a, a, function (a, c) {
        ...
        c !== f ? (b.K(), b.options.errorCallback({$element: b.a, type: "IMAGE_NOT_FOUND", data: c.ia})) : b.ka()
    })
};
J.prototype.va = function () {
    ...
    a.ca = setTimeout(function () {
        ...
        r("body").append(a.o);
        var b = a.o.width(), c = a.o.height(), b = a.a.offset().left + a.a.width() / 2 - b / 2, c = a.a.offset().top + a.a.height() / 2 - c / 2;
        a.o.offset({left: b, top: c})
    }, 250);
    var c = r(new Image).css({display: "none", position: "absolute"});
    r("body").append(c);
    this.v = new K(c, this.N, function (b, d) {
        ...
        a.g = c.height();
        c.remove();
        d !== f ? (a.K(), a.options.errorCallback({$element: a.a, type: "IMAGE_NOT_FOUND", data: d.ia})) : a.ka()
    })
};
...
q.ka = function () {
    ...
    if (a.$ && a.U) {
        ...
        if (!a.T) {
            ...
            a.Q();
            var c = 0, b = 0, d = 0, e = function (a, b) {
                return Math.sqrt((a.pageX - b.pageX) * (a.pageX - b.pageX) + (a.pageY - b.pageY) * (a.pageY - b.pageY))
            };
            a.a.bind("touchstart touchmove touchend", function (g) {
                if (a.ea()) return h;
                var l = a.a.offset(), m = g.originalEvent;
                g = {x: 0, y: 0};
                var p = m.type;
            ...
            if (a.C != j) {
                var g = a.a.offset(), g = new J.B(a.C.pageX - g.left, a.C.pageY - g.top);
                a.H();
                a.w();
                a.q(g, 0)
            }
...
q.w = function () {
    ...
    a.e = a.a.width() * this.i;
    a.g = a.a.height() * this.i;
    var c = this.l, b = a.d, d = a.c, e = a.e, g = a.g, n = a.caption;
    if ("inside" == a.options.zoomPosition) c.width(a.d / a.e * a.d), c.height(a.c / a.g * a.c), c.css("display", "none"), a.h = new L({
        ...
        var l = a.options.zoomOffsetX, m = a.options.zoomOffsetY, p = k, e = c.width() / b * e, g = c.height() / d * g, u = a.options.zoomSizeMode;
...
J.prototype.q = function (a, c) {
    ...
    var e = this.F;
    this.l.parent();
    this.l.css({left: Math.ceil(b) - e, top: Math.ceil(d) - e});
    b = -b;
    d = -d;
    this.D.css({left: Math.floor(b) + "px", top: Math.floor(d) + "px"});
    this.ma = b;
    this.na = d
};
J.ja = function (a) {
    var c = r.fn.CloudZoom.attr, b = j;
    a = a.attr(c);
    if ("string" == typeof a) {
        a = r.trim(a);
...
J.Ba = function () {
    r["ajax"]({
        url: x + "/" + "license.js", dataType: "script", async: k, Da: h, success: function () {
            E = h
        }
    })
};
...
r.fn.CloudZoom = function (a) {
    return this.each(function () {
        if (r(this).hasClass("cloudzoom-gallery")) {
            var c = J.ja(r(this)), b = r(c.useZoom).data("CloudZoom");
            b.sa(r(this), c);
            var d = r.extend({}, b.options, c), e = r(this).parent(), g = d.zoomImage;
            e.is("a") && (g = e.attr("href"));
            b.m.push({href: g, title: r(this).attr("title")});
...
function L(a) {
    var c = a.zoom, b = a.L, d = a.M, e = a.e, g = a.g;
    this.data = a;
    this.O = this.b = j;
    this.oa = 0;
    this.zoom = c;
    ...
    a.caption ? ("html" == c.options.captionType ? l = a.caption : "attr" == c.options.captionType && (l = r("<div class='cloudzoom-caption'>" + a.caption + "</div>")), l.css("display", "block"), u.css({width: e}), p.append(u), u.append(l), r("body").append(p), this.r = l.outerHeight(), "bottom" == c.options.captionPosition || "inside" == c.options.zoomPosition ? u.css("top", g) : (u.css("top", 0), this.oa = this.r)) : r("body").append(p);
    p.css({opacity: 0, width: e, height: g + this.r});
    ...
    c.options.zoomFlyOut ? (g = c.a.offset(), g.left += c.d / 2, g.top += c.c / 2, p.offset(g), p.width(0), p.height(0), p.animate({
        ...
        duration: c.options.animationTime, complete: function () {
            n.P = h
        }
    })) : (p.offset({
        left: b,
        top: d
    }), p.width(e), p.height(a), p.animate({opacity: 1}, {
        duration: c.options.animationTime, complete: function () {
            n.P = h
        }
    }))
...
L.prototype.update = function () {
    var a = this.zoom, c = a.i, b = -a.ma + a.n / 2, d = -a.na + a.k / 2;
    this.p == f && (this.p = b, this.s = d);
    this.p += (b - this.p) / a.options.easing;
    this.s += (d - this.s) / a.options.easing;
    var b = -this.p * c, b = b + a.n / 2 * c, d = -this.s * c, d = d + a.k / 2 * c, e = a.a.width() * c, a = a.a.height() * c;
    0 < b && (b = 0);
    0 < d && (d = 0);
    b + e < this.b.width() && (b += this.b.width() - (b + e));
    d + a < this.b.height() - this.r && (d += this.b.height() - this.r - (d + a));
    this.O.css({left: b + "px", top: d + this.oa + "px", width: e, height: a})
};
